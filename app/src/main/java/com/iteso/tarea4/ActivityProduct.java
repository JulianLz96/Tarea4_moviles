...
public class ActivityProduct extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        save = findViewById(R.id.item_prduct_button_save);
        cancel = findViewById(R.id.item_prduct_button_cancel);
        title = findViewById(R.id.item_prduct_edit_text_brand);
        store = findViewById(R.id.item_prduct_edit_text_store);
        location = findViewById(R.id.item_prduct_edit_text_location);
        phone = findViewById(R.id.item_prduct_edit_text_phone);
